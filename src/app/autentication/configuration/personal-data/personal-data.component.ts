...
export class PersonalDataComponent implements OnInit {
    ...
    populateForm(data: any) {
        ...
        if ((data.address !== null && data.address !== undefined) && (data.city !== null && data.city !== undefined)) {
            ...
            if (data.address.zipCode !== null && data.address.zipCode !== undefined) {
    ...
    async getStates() {
        await this.requestService.get("Address/GetStates").subscribe(
            async (node: any) => {
                const consulting: any = node.find(
                    (a) => a.id === this.formPersonal.controls.estado.value
                );
                if (consulting !== null && consulting !== undefined) {
